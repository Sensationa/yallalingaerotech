...
import { ArrowLeft, CheckCircle2, Radar, ShieldCheck } from "lucide-react";
...
function AerospacePage() {
  return <main className="min-h-screen px-5 py-8 lg:px-8"><div className="mx-auto max-w-6xl">
    <nav className="border-b border-border pb-6"><Button variant="ghost" asChild><Link to="/"><ArrowLeft /> Portfolio</Link></Button></nav>
