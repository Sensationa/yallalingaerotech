...
export const Route = createFileRoute("/resume")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://yallalingaerotech.lovable.app/resume" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://yallalingaerotech.lovable.app/resume" }],
  }),
  ...
  return <main className="min-h-screen px-5 py-8 lg:px-8">
    <div className="mx-auto max-w-5xl">
      <nav className="flex flex-wrap items-center justify-between gap-4 border-b border-border pb-6" aria-label="Resume navigation">
        ...
        <div className="flex flex-wrap gap-3"><Button variant="console" asChild><a href="/Yallaling-Avionics-Resume.pdf"><ArrowRight /> View PDF</a></Button><Button variant="signal" asChild><a href="/Yallaling-Avionics-Resume.pdf" download="Yallaling-Resume.pdf"><Download /> Download PDF</a></Button></div>
      </nav>
